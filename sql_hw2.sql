...
--2) Наполнить таблицу employees 70 строками. (сделаем через пайтон)
...
--3)	Создать таблицу salary (но она уже была и заполнена ненужными данными. пропишем команду, как создать таблицу,
--затем удалим колонку и добавим колонку (поменять на NULL нельзя), после чего заполним)
-- id. Serial  primary key,
...
-- 4)	Наполнить таблицу salary 15 строками (сделаем вручную):
--- 1000
--- 1100
--- 1200
--- 1300
